...
# Display the table with caption
kable(irr_table, caption = "Table 1. Interrater and retest reliability statistics for 13 ethnographic variables coded in the HRAF Fasting Dataset. Columns show percent agreement between human annotators, Gwet's AC1, Cohen's Kappa, and percent agreement on retest.") %>%
  kable_styling(position = "left")


# # Manually insert caption below
# cat("
...
knitr::kable(table2, caption = "Table 2 presents a the variable operationalizations used to analyze fasting practices. The table categorizes variables by type each with specific indicators and descriptions to guide annotation of fasting-related texts or behaviors.", longtable = TRUE, booktabs = TRUE)
