...
library(dplyr)
library(stringr)
d0 <- read_excel("/Users/kristensyme/Desktop/R Projects/Fasting/Original Data/Full Unresolved Dataset.xlsx")
subset <- read_excel("/Users/kristensyme/Desktop/R Projects/Fasting/Original Data/Reconciled subset copy.xlsx")
